  ...
  return ( 
          ...
          <ul className="flex text-white">
            ...
            <li className="ml-6">
              <div className="flex items-center">
                ...
                <span className="ml-2">+507 310-4567</span>
              </div>
            </li>
          </ul>
        </div>
    ...
    <section
      ...
      <div className="md:flex md:items-center md:justify-center">
        <h2 className="text-xl font-bold text-white">¡Ponte en contacto con nosotros hoy mismo!  <br className="block md:hidden"/>Llámanos al: +507 310-4567</h2>
