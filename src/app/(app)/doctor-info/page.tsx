    ...
    <div className="flex flex-col p-6 gap-y-4">
      ...
      <div className="flex flex-col gap-y-6">
        <h1 className="text-2xl sm:text-3xl">
          Especialistas en, <span className="text-[#89ccc5] block sm:inline">{doctor.especialidad}</span>
        </h1>
        ...
        <div className="md:flex md:flex-row-reverse">
          ...
          <div className="flex-1 flex flex-col items-center">
            ...
            <Link className="bg-[#89ccc5] hover:bg-[#70a8a3] mx-auto h-12 px-3 mt-2 text-lg font-normal rounded flex justify-center items-center text-white" href={'/doctor-info/addcita'}>Agendar Cita</Link>
          </div>
        </div>
      </div>
      <MobileNavigation/>
