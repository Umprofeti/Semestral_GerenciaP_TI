            ...
            <div className="md:h-3/5 grid grid-cols-2 bg-[#89ccc5] md:bg-white">
                ...
                <div className="col-end-3 hidden md:block">
                    <div className="grid grid-cols-2 gap-y-4 ">
                        <Link className="bg-[#89ccc5] hover:bg-[#70a8a3] w-5/6 mx-auto h-12 text-lg font-normal rounded flex justify-center items-center text-white" href={'/profileuser/user'}>Información del Paciente</Link>                 
