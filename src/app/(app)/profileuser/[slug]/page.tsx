        ...
        <div className="w-full h-screen flex flex-col ">
            ...
            <div className="w-full flex-grow bg-white md:bg-[#89ccc5] rounded-t-3xl relative">
                ...
                <div className="flex md:hidden flex-col space-y-4 pt-8">
                    <Link className="bg-[#89ccc5] hover:bg-[#70a8a3] w-5/6 mx-auto h-12 text-lg font-normal rounded flex justify-center items-center text-white" href={`/profileuser/${result?.docs[0].id}`}>Información del Paciente</Link>
